...
metadata:
  short-description: Vendor local Rust crates
---
...
- The user may type the path directly
...
3. Ask the user directly to choose among navigation options:
...
3. Ask the user directly to choose among branches, with:
...
3. Ask the user directly to choose among commits:
...
3. Ask the user directly to confirm:
...
3. Ask the user if they want to commit now:
