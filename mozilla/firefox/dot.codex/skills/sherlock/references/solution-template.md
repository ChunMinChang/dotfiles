...
> option write-ups. Effort, risk, performance, and uplift columns are descriptive
> comparisons requested during Design; they carry no weights, scores, or ranking.
> Practical weighting and the recommendation remain exclusively in Decide.
